...
def rotate_RX_2(z,params,a,alpha,modes):
    ...
    J_1 = (
        ...
        + (3*a*b**2*k**2*z**2)/(2*R**2)
          - (6*1j*a*b**2*k*z**2)/(R*w_z**2)
    )
    ...
    J_2 = (
        ...
        (
            1j*b**2*k/(2*R)
            +a*b*z*k**2/(R**2) #change to plus
            +b**2*k**2*z/R
            -4*1j*a*b*k*z/(R*w_z**2)
            -b**2*k**2*z**2/(2*R**2) #change to minus
            +2*1j*b**2*k*z**2/(R*w_z**2)
        )
    )
    ...
    J_3 = (
        ...
        (
            -1j*a*b**2*k**3/(2*R)
            +2*1j*a*b**2*k/(R*w_z**2)
            -(a*b**2*k**2)/(2*R**2)
            -1j*a*b**2*k**3*z/(R**2)
            +4*a*b**2*k**2*z/(R*w_z**2)
        )
        +
        (
         (6*1j*a*b**2*k*z**2)/(R*w_z**4)
            -(3*a*b**2*k**2*z**2)/(R**2*w_z**2)
            -(1j*a*b**2*k**3*z**2)/(2*R**3)
        )
    )
