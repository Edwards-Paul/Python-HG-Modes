    ...
    for n in range(rows):
        for m in range(cols):            
            ...
            if (modes[n][m]!=0 and (n>0) ): #neglect n-1
                ...
                x_31 = x_minus_31(w0,z,zr,n)
                x_1_m = x_minus_1(w0,z,zr,n-1)
...
#x**3 dep
def x_plus_3(w0,z,zr,n):
    factor = 0
    return(factor)

def x_plus_31(w0,z,zr,n):
    factor = 0
    return(factor)

def x_minus_31(w0,z,zr,n):
    factor = 0
    return(factor)

def x_minus_3(w0,z,zr,n):
    factor = 0
    return(factor)
